...
public class CustomThreadPool extends ThreadPoolExecutor {
  ...
  public CustomThreadPool(int corePoolSize, int maxPoolSize, int poolTimeout, BlockingQueue<Runnable> blockingQueue, ThreadFactory tf) {
  ...
  protected void afterExecute(Runnable r, Throwable t) {
    try {
      ...
      logger.info("Runnable " + Thread.currentThread().getName() + " ends after " + taskTime + " milliseconds" + "; current active: " + this.getActiveCount());
      if (t != null) {
